...
class HallucinationDetector:
    ...
    def detect(self, sql: str, schema: SchemaSnapshot, dialect: str = None) -> HallucinationReport:
    ...
    def validate(self, sql: str, schema: SchemaSnapshot, dialect: str = None) -> ValidationResult:
        dialect = dialect or self.dialect
        ...
        for func in report.phantom_functions:
            warnings.append(f"Function '{func}' may not be valid for {dialect}")
    ...
    def _detect_phantom_tables(self, tables, aliases, schema):
        phantom = []
        cte_aliases = {
    ...
    def _detect_phantom_columns(self, columns, tables, aliases, schema,
                                 select_aliases=None, cte_columns=None):
        phantom = []
    ...
    def _detect_phantom_functions(self, functions, dialect):
        phantom = []
        try:
    ...
    def _is_function_alias(self, func, valid_functions):
        aliases = {
            "LEN": {"LENGTH"},
            "SUBSTR": {"SUBSTRING"},
